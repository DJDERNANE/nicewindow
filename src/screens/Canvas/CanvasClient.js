import React, { useCallback, useContext, useEffect, useState, Screen, useRef } from "react";
import { Pressable, StyleSheet, Text, Vie, FlatList, View, TouchableOpacity } from "react-native";
...
const CanvasScreen = () => {
    ...
    const getShapesConfirmed = async () => {
        ...
        fetch(CARPENTRY_API_LINK + '/shapesConfirmed?id=' + client.id + '&orderId='+ id, {
            method: 'GET',
            headers: {
        ...
        <View style={styles.container}>
            ...
            <View style={stylesMain.container}>
                <View style={{ paddingHorizontal: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10 }}>
                    <Text >Price total: <TextBold >{total}</TextBold>  Da</Text>
