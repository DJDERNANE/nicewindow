...
const SupplierAccountingScreen = () => {
  ...
  const getRevenu = async () => {
    try {
      const user = await AsyncStorage.getItem("user");
      const response = await fetch(
        `${SUPPLIER_API_LINK}/accounting/totalprofit`,
        {
          method: "GET",
          headers: {
            Accept: "application/json",
  ...
  const filter = async () => {
    ...
    try {
      const user = await AsyncStorage.getItem("user");
      const url = endDay
        ? `${SUPPLIER_API_LINK}/accounting/total/filter?startday=${startDay}&&endday=${endDay}`
        : `${SUPPLIER_API_LINK}/accounting/total/filter?startday=${startDay}`;
          ...
          {loading ? (
            ...
            <View>
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate("Revenu")}
              >
                <View>
                  <TextBold
