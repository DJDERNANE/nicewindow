...
const WhatsAppButton = () => {
    const openWhatsApp = () => {
        const phoneNumber = '+213662167266'; // Enter the phone number you want to message
    ...
    return (
        <TouchableOpacity onPress={openWhatsApp} style={{ flexDirection: 'row', alignItems: 'center' }}>
...
const EndSub = () => {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <TextBold>
                Contact us to get a new subscription.
            </TextBold>
            <TextBold>
                0662167266
            </TextBold>
