...
class CartScreen extends Component {
  ...
  async storeOrder() {
    ...
    fetch(CARPENTRY_API_LINK + "/profile/order/store", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    const renderItem = ({ item }) => {
      return (
        <View>
          ...
          >
            <Text style={Radiostyles.optionText}>
                ...
                return (
                  <Pressable
                    style={[
                      styles.formGroup,
                      styles.addressView,
                      s.selected_shipping_address === data.address && {
                        borderColor: PRIMARY,
                      },
                    ]}
                    key={key}
                    onPress={() =>
                      this.setState({ selected_shipping_address: data.address })
                    }
                  >
