          ...
          <View style={styles.container}>
            <View style={styles.header}>
              <TextBold style={styles.title}>
                {i18n.t("suppliers.favorites")}
              </TextBold>
              <Pressable
                onPress={() =>
                  this.props.navigation.navigate("CarpentrySuppliersSearch")
                }
              >
                <TextMedium style={styles.moreText}>
                  {i18n.t("suppliers.search")}
                </TextMedium>
              </Pressable>
            </View>
            {s.suppliersLoading ? (
              ...
              s.suppliersData &&
              s.suppliersData.length > 0 &&
              s.suppliersData.map((data, key) => {
                return <SupplierCard data={data.supplier} key={key} />;
              })
            )}
          </View>
        </ScrollView>
