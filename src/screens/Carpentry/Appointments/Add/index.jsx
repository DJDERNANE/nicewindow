        ...
        <ScrollView keyboardShouldPersistTaps={'handled'}>
          ...
          <View style={styles.container}>
            <View style={styles.formGroup}>
              <Label required>{ i18n.t('appointments.labels.client_name') }: </Label>
              <DefaultInput 
                onChangeText={(value) => this.handleChange('client_name', value)} 
                value={s.client_name} 
              />
            </View>
            <View style={styles.formGroup}>
              <Label required>{ i18n.t('appointments.labels.client_mobile') }: </Label>
              <DefaultInput 
                onChangeText={(value) => this.handleChange('client_mobile', value)} 
            ...
            <View style={styles.formGroup}>
              <ButtonDefault text={ i18n.t('appointments.buttons.save') } onPress={() => this.store()} />
            </View>
          </View>
        </ScrollView>
      </Screen>
