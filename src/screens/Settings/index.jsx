      ...
      <Screen>
        <ScrollView>
          <View style={styles.container}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => p.navigation.navigate("GeneralSettings")}
            >
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() => p.navigation.navigate("SecuritySettings")}
            >
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={() => p.navigation.navigate("LanguagesSettings")}
            >
...

            {
              <TouchableOpacity
                style={styles.button}
                onPress={() => p.navigation.navigate("SubscribtionsSettings")}
              >
            ...
            {Number(JSON.parse(s.user).type) === 3 && (
              <TouchableOpacity
                style={styles.button}
                onPress={() => p.navigation.navigate("LocationsSettings")}
              >
            ...
            {Number(JSON.parse(s.user).type) === 2 &&
              !JSON.parse(s.user).master_id && (
                <Fragment>
                  <TouchableOpacity
                    style={styles.button}
                    onPress={() => p.navigation.navigate("LocationsSettings")}
                  ...
                  <TouchableOpacity
                    style={styles.button}
                    onPress={() => p.navigation.navigate("UsersSettings")}
                  >
