      ...
      <Screen>
        ...
        <View style={styles.container}>
          <View style={styles.formGroup}>
            <Label required>{i18n.t('settings.locations.labels.address')}: </Label>
            <LocationInput
              onPress={(address) => this.setState({ address: address.description })}
              detectLocation={()=>console.log('ok')}
            />
          </View>
          <View style={styles.formGroup}>
            <Label required>{i18n.t('settings.locations.labels.responsible_name')}: </Label>
            <DefaultInput
              onChangeText={(value) => this.setState({ responsible_name: value })}
              value={s.responsible_name}
            />
          </View>
          <View style={styles.formGroup}>
            <Label required>{i18n.t('settings.locations.labels.responsible_mobile')}: </Label>
            <DefaultInput
              onChangeText={(value) => this.setState({ responsible_mobile: value })}
