    ...
    <BottomModalContainer isVisible={props.isVisible}>
      <View style={styles.body}>
              ...
              return (
                ...
                >
                  <TextMedium
                    style={[
                      styles.packageText,
                      props.selectedPackage === data.id && { color: WHITE },
                    ]}
                  >
        ...
        <View style={styles.delayView}>
          <Pressable
            style={[
              styles.delayItem,
              props.selectedDelay === 1 && { backgroundColor: PRIMARY },
            ]}
          ...
          >
            <TextMedium
              style={[
                styles.delayText,
                props.selectedDelay === 1 && { color: WHITE },
              ]}
            >
              1 Month
            </TextMedium>
          ...
          <Pressable
            style={[
              styles.delayItem,
              props.selectedDelay === 6 && { backgroundColor: PRIMARY },
            ]}
          ...
          >
            <TextMedium
              style={[
                styles.delayText,
                props.selectedDelay === 6 && { color: WHITE },
              ]}
            >
              6 Months
            </TextMedium>
          ...
          <Pressable
            style={[
              styles.delayItem,
              props.selectedDelay === 12 && { backgroundColor: PRIMARY },
            ]}
          ...
          >
            <TextMedium
              style={[
                styles.delayText,
                props.selectedDelay === 12 && { color: WHITE },
              ]}
            >
              1 Year
            </TextMedium>
      ...
      <View style={styles.footer}>
        ...
        <ButtonDefault
          ...
          disabled={
            !props.image || !props.selectedDelay || !props.selectedPackage
          }
        />
      </View>
