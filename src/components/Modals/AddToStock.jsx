      ...
      <ScrollView>
        <View style={styles.body}>
          <View style={styles.formGroup}>
            <Text style={Radiostyles.text}>Le Type Selectionner : {props.TheType? props.TheType : null}</Text>
            <FlatList
              data={props.proTypes}
          ...
          <View >
            ...
            <Text style={Radiostyles.text}> Choisissez un Coleur : <View style={{width:20,height:20, backgroundColor: props.TheColor? props.TheColor : 'transparent'}}></View> </Text>
            <FlatList
              data={props.colors}
              horizontal
