...
export const ClientOrder = ({
  ...
  return (
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate("CanvasClient", {
          client: client,
          total: price,
          id: id,
        })
    ...
    >
      ...
      <TextMedium style={styles.detailsText}>Paye: {paye} DZD</TextMedium>
      <TextMedium style={styles.detailsText}>Il reste: {credit} DZD</TextMedium>
      <ButtonDefault
        text={"Paye"}
        size="sm"
