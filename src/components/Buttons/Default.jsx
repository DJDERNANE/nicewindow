    ...
    <TouchableOpacity 
      style={
        [
          ...
          {
            backgroundColor: props.disabled ? LIGHT_GRAY : props.color ? props.color : PRIMARY,
            paddingHorizontal: props.size === 'sm' ? 8 : props.size === 'md' ? 12 : 18,
            paddingVertical: props.size === 'sm' ? 6 : props.size === 'md' ? 10 : 14
          }
        ]
      } 
